...
if TYPE_CHECKING:
    from ..models.merkmal_parameters_of_the_dynamic_property_item_names_in_language_item import (
        MerkmalParametersOfTheDynamicPropertyItemNamesInLanguageItem,
    )


T = TypeVar("T", bound="MerkmalParametersOfTheDynamicPropertyItem")


@_attrs_define
class MerkmalParametersOfTheDynamicPropertyItem:
    """
    Attributes:
        id (Union[Unset, str]):
        names_in_language (Union[Unset, List['MerkmalParametersOfTheDynamicPropertyItemNamesInLanguageItem']]):
    ...
    names_in_language: Union[Unset, List["MerkmalParametersOfTheDynamicPropertyItemNamesInLanguageItem"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for names_in_language_item_data in _names_in_language or []:
            names_in_language_item = MerkmalParametersOfTheDynamicPropertyItemNamesInLanguageItem.from_dict(
        ...
        merkmal_parameters_of_the_dynamic_property_item = cls(
            id=id,
        ...
        merkmal_parameters_of_the_dynamic_property_item.additional_properties = d
        return merkmal_parameters_of_the_dynamic_property_item
