...
if TYPE_CHECKING:
    from ..models.merkmal_replaces_item_names_in_language_item import MerkmalReplacesItemNamesInLanguageItem


T = TypeVar("T", bound="MerkmalReplacesItem")


@_attrs_define
class MerkmalReplacesItem:
    """
    Attributes:
        id (Union[Unset, str]):
        names_in_language (Union[Unset, List['MerkmalReplacesItemNamesInLanguageItem']]):
    ...
    names_in_language: Union[Unset, List["MerkmalReplacesItemNamesInLanguageItem"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for names_in_language_item_data in _names_in_language or []:
            names_in_language_item = MerkmalReplacesItemNamesInLanguageItem.from_dict(names_in_language_item_data)
        ...
        merkmal_replaces_item.additional_properties = d
        return merkmal_replaces_item
