...
T = TypeVar("T", bound="MerkmalsgruppeReplacesItemNamesInLanguageItem")


@_attrs_define
class MerkmalsgruppeReplacesItemNamesInLanguageItem:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        merkmalsgruppe_replaces_item_names_in_language_item = cls(
            name=name,
            language=language,
        ...
        merkmalsgruppe_replaces_item_names_in_language_item.additional_properties = d
        return merkmalsgruppe_replaces_item_names_in_language_item
