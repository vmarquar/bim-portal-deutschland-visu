...
T = TypeVar("T", bound="MerkmalReplacedByItemNamesInLanguageItem")


@_attrs_define
class MerkmalReplacedByItemNamesInLanguageItem:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        merkmal_replaced_by_item_names_in_language_item = cls(
            name=name,
            language=language,
        ...
        merkmal_replaced_by_item_names_in_language_item.additional_properties = d
        return merkmal_replaced_by_item_names_in_language_item
