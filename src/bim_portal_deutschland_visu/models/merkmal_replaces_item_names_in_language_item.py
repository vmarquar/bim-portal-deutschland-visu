...
T = TypeVar("T", bound="MerkmalReplacesItemNamesInLanguageItem")


@_attrs_define
class MerkmalReplacesItemNamesInLanguageItem:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        merkmal_replaces_item_names_in_language_item = cls(
            name=name,
            language=language,
        ...
        merkmal_replaces_item_names_in_language_item.additional_properties = d
        return merkmal_replaces_item_names_in_language_item
