...
T = TypeVar("T", bound="MerkmalGroupOfPropertiesItemNamesInLanguageItem")


@_attrs_define
class MerkmalGroupOfPropertiesItemNamesInLanguageItem:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        merkmal_group_of_properties_item_names_in_language_item = cls(
            name=name,
            language=language,
        ...
        merkmal_group_of_properties_item_names_in_language_item.additional_properties = d
        return merkmal_group_of_properties_item_names_in_language_item
