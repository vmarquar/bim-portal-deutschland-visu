...
if TYPE_CHECKING:
    from ..models.merkmalsgruppe_replaced_by_item_names_in_language_item import (
        MerkmalsgruppeReplacedByItemNamesInLanguageItem,
    )


T = TypeVar("T", bound="MerkmalsgruppeReplacedByItem")


@_attrs_define
class MerkmalsgruppeReplacedByItem:
    """
    Attributes:
        id (Union[Unset, str]):
        names_in_language (Union[Unset, List['MerkmalsgruppeReplacedByItemNamesInLanguageItem']]):
    ...
    names_in_language: Union[Unset, List["MerkmalsgruppeReplacedByItemNamesInLanguageItem"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for names_in_language_item_data in _names_in_language or []:
            names_in_language_item = MerkmalsgruppeReplacedByItemNamesInLanguageItem.from_dict(
        ...
        merkmalsgruppe_replaced_by_item = cls(
            id=id,
        ...
        merkmalsgruppe_replaced_by_item.additional_properties = d
        return merkmalsgruppe_replaced_by_item
