...
T = TypeVar("T", bound="MerkmalConnectedPropertiesItemNamesInLanguageItem")


@_attrs_define
class MerkmalConnectedPropertiesItemNamesInLanguageItem:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        merkmal_connected_properties_item_names_in_language_item = cls(
            name=name,
            language=language,
        ...
        merkmal_connected_properties_item_names_in_language_item.additional_properties = d
        return merkmal_connected_properties_item_names_in_language_item
