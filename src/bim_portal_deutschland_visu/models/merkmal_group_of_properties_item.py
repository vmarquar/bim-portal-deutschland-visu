...
if TYPE_CHECKING:
    from ..models.merkmal_group_of_properties_item_names_in_language_item import (
        MerkmalGroupOfPropertiesItemNamesInLanguageItem,
    )


T = TypeVar("T", bound="MerkmalGroupOfPropertiesItem")


@_attrs_define
class MerkmalGroupOfPropertiesItem:
    """
    Attributes:
        id (Union[Unset, str]):
        names_in_language (Union[Unset, List['MerkmalGroupOfPropertiesItemNamesInLanguageItem']]):
    ...
    names_in_language: Union[Unset, List["MerkmalGroupOfPropertiesItemNamesInLanguageItem"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for names_in_language_item_data in _names_in_language or []:
            names_in_language_item = MerkmalGroupOfPropertiesItemNamesInLanguageItem.from_dict(
        ...
        merkmal_group_of_properties_item = cls(
            id=id,
        ...
        merkmal_group_of_properties_item.additional_properties = d
        return merkmal_group_of_properties_item
