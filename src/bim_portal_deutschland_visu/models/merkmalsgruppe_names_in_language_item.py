...
T = TypeVar("T", bound="MerkmalsgruppeNamesInLanguageItem")


@_attrs_define
class MerkmalsgruppeNamesInLanguageItem:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        merkmalsgruppe_names_in_language_item = cls(
            name=name,
            language=language,
        ...
        merkmalsgruppe_names_in_language_item.additional_properties = d
        return merkmalsgruppe_names_in_language_item
