...
T = TypeVar("T", bound="MerkmalNamesInLanguageItem")


@_attrs_define
class MerkmalNamesInLanguageItem:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        merkmal_names_in_language_item = cls(
            name=name,
            language=language,
        ...
        merkmal_names_in_language_item.additional_properties = d
        return merkmal_names_in_language_item
