...
if TYPE_CHECKING:
    from ..models.merkmal_replaced_by_item_names_in_language_item import MerkmalReplacedByItemNamesInLanguageItem


T = TypeVar("T", bound="MerkmalReplacedByItem")


@_attrs_define
class MerkmalReplacedByItem:
    """
    Attributes:
        id (Union[Unset, str]):
        names_in_language (Union[Unset, List['MerkmalReplacedByItemNamesInLanguageItem']]):
    ...
    names_in_language: Union[Unset, List["MerkmalReplacedByItemNamesInLanguageItem"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for names_in_language_item_data in _names_in_language or []:
            names_in_language_item = MerkmalReplacedByItemNamesInLanguageItem.from_dict(names_in_language_item_data)
        ...
        merkmal_replaced_by_item.additional_properties = d
        return merkmal_replaced_by_item
