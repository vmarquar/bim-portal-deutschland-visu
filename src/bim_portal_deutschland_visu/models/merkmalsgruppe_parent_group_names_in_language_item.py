...
T = TypeVar("T", bound="MerkmalsgruppeParentGroupNamesInLanguageItem")


@_attrs_define
class MerkmalsgruppeParentGroupNamesInLanguageItem:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        merkmalsgruppe_parent_group_names_in_language_item = cls(
            name=name,
            language=language,
        ...
        merkmalsgruppe_parent_group_names_in_language_item.additional_properties = d
        return merkmalsgruppe_parent_group_names_in_language_item
