...
T = TypeVar("T", bound="MerkmalsgruppeMetadata")


@_attrs_define
class MerkmalsgruppeMetadata:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        merkmalsgruppe_metadata.additional_properties = d
        return merkmalsgruppe_metadata
