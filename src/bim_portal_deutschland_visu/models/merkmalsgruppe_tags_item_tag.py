...
T = TypeVar("T", bound="MerkmalsgruppeTagsItemTag")


@_attrs_define
class MerkmalsgruppeTagsItemTag:
    """
    Attributes:
        id (Union[Unset, str]):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        merkmalsgruppe_tags_item_tag = cls(
            id=id,
            name=name,
        ...
        merkmalsgruppe_tags_item_tag.additional_properties = d
        return merkmalsgruppe_tags_item_tag
