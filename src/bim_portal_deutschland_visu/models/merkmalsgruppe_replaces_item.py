...
if TYPE_CHECKING:
    from ..models.merkmalsgruppe_replaces_item_names_in_language_item import (
        MerkmalsgruppeReplacesItemNamesInLanguageItem,
    )


T = TypeVar("T", bound="MerkmalsgruppeReplacesItem")


@_attrs_define
class MerkmalsgruppeReplacesItem:
    """
    Attributes:
        id (Union[Unset, str]):
        names_in_language (Union[Unset, List['MerkmalsgruppeReplacesItemNamesInLanguageItem']]):
    ...
    names_in_language: Union[Unset, List["MerkmalsgruppeReplacesItemNamesInLanguageItem"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for names_in_language_item_data in _names_in_language or []:
            names_in_language_item = MerkmalsgruppeReplacesItemNamesInLanguageItem.from_dict(
        ...
        merkmalsgruppe_replaces_item = cls(
            id=id,
        ...
        merkmalsgruppe_replaces_item.additional_properties = d
        return merkmalsgruppe_replaces_item
