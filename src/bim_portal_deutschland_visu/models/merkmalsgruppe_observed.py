...
T = TypeVar("T", bound="MerkmalsgruppeObserved")


@_attrs_define
class MerkmalsgruppeObserved:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        merkmalsgruppe_observed = cls(
            observation_id=observation_id,
        )

        merkmalsgruppe_observed.additional_properties = d
        return merkmalsgruppe_observed
